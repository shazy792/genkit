...
from genkit.plugins.openai.typing import (
...
class OpenAIModel:
    ...
    def __init__(self, model: str, **openai_options: Any):
        """
        ...
        :param openai_options: Additional keyword arguments for configuring the OpenAI client.
        """
        self._model = model
        self._openai_client = OpenAI(**openai_options)
